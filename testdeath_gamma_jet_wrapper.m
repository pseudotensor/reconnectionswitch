...
whichastrosystem=1;
Clear[rl];
If[whichastrosystem==1,prefix="grb";rin=rl;rout=10.0^Ceiling[Log[10,10^(12)*rl]];rsingle=5*10^(14);muin=50;muout=10^(6);musingle=10^4;br0in=10^8;br0out=10^(17);br0single=10^(15);nuin=0.1;nuout=1.0;nusingle=3/4;rmonoin=rl;rmonoout=rout;rmonosingle=3*10^(10);thfpin=Pi/20;thfpout=Pi/2;thfpsingle=Pi/2;lmodein=2.0;lmodeout=10^4;lmodesingle=2.0;mmodein=10^(-2);mmodeout=10^4;mmodesingle=0;];
If[whichastrosystem==2,prefix="m87";rin=rl;rout=10.0^Ceiling[Log[10,10^(12)*rl]];rsingle=10^8*rl;muin=50;muout=10^(6);musingle=50;br0in=10;br0out=10^6;br0single=10^3;nuin=0.1;nuout=1.0;nusingle=3/4;rmonoin=rl;rmonoout=rout;rmonosingle=100*rl;thfpin=Pi/20;thfpout=Pi/2;thfpsingle=Pi/2;lmodein=2.0;lmodeout=10^4;lmodesingle=2.0;mmodein=10^(-2);mmodeout=10^4;mmodesingle=0;];
If[whichastrosystem==3,prefix="grs";rin=rl;rout=10.0^Ceiling[Log[10,10^(12)*rl]];rsingle=10^8*rl;muin=50;muout=10^(6);musingle=50;br0in=10^6;br0out=10^11;br0single=10^9;nuin=0.1;nuout=1.0;nusingle=3/4;rmonoin=rl;rmonoout=rout;rmonosingle=100*rl;thfpin=Pi/20;thfpout=Pi/2;thfpsingle=Pi/2;lmodein=2.0;lmodeout=10^4;lmodesingle=2.0;mmodein=10^(-2);mmodeout=10^4;mmodesingle=0;];
];
